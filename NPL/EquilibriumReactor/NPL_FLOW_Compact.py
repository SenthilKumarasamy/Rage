...
#     StrmH1=Material_Stream('StrmH1',FIC3103,TI3156,PIC3150,2,T1,CTag2)
    ...
    REX1=Reactor('REX1',StrmNS1,StrmNS3,[E2],[RE1,RE2,RE3,RE4,RE5],ExoEndoFlag=1)
    ...
    REX1a=PreReformer('REX1a',StrmNS3,StrmNS3a,[E2a],[RE6,RE7],[0,0],ExoEndoFlag=1)
    ...
    REX2=SteamReformer('REX2',StrmNS4,StrmNS6,[E4],[RE7a,RE8],[0,0],ExoEndoFlag=1)
    ...
    REX3=ShiftReactor('REX3',StrmNS6,StrmHT1,[E5],[RE8],[0.0],ExoEndoFlag=-1)
    ...
    REX4=ShiftReactor('REX4',StrmHT1,StrmLT1,[E6],[RE8],[0.0],ExoEndoFlag=-1)
    ...
    SPL4=Splitter('SPL4',StrmST8,[StrmST1,StrmST2,StrmST5])
    ...
    MIX5=Mixer('MIX5',[StrmAR2,StrmNG2,StrmLT4],StrmAN1)
    ...
    REX5=Reactor('REX5',StrmAN1,StrmFG1,[E4],[RE9,RE10,RE11,RE12,RE13,RE14,RE15,RE16],ExoEndoFlag=-1)
    ...
    SEP1=Seperator('SEP1',StrmLT1,[StrmLT3,StrmW6])
...
#     
    ...
    SPL8=Splitter('SPL8',StrmW5,[StrmW8,StrmW1,StrmW4])
