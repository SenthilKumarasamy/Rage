''' Splitter Example with Material, Component, Energy, and Pressure Balances with normalization'''
import sys
import os
...
class Test13():
    def __init__(self,Ctol=1e-5,Ptol=1):
        self.Description='Splitter Example with Material, Component, Energy, and Pressure Balances with normalization'
        self.Type=7
        ...
        F1.Sol=103.9594442619504
        T1=Sensor(25)
        T1.Sigma=0.01*T1.Meas
        T1.Sol=24.7866693840330
        P1=Sensor(105)
        P1.Sigma=0.01*P1.Meas
        P1.Sol=100.3082141145146
        H2_S1=Sensor(0.55)
        H2_S1.Sigma=0.01*H2_S1.Meas
        H2_S1.Sol=0.5111738865356
        CO_S1=Sensor(0.49)
        CO_S1.Sigma=0.01*CO_S1.Meas
        CO_S1.Sol=0.4888261134644
        ...
        F2.Sol=49.5291602636148
        T2=Sensor(23)
        T2.Sigma=0.01*T2.Meas
        T2.Sol=24.7866693840330
        P2=Sensor(102)
        P2.Sigma=0.01*P2.Meas
        P2.Sol=100.3082141145146
        H2_S2=Sensor(0.50)
        H2_S2.Sigma=0.01*H2_S2.Meas
        H2_S2.Sol=0.5111738865356
        CO_S2=Sensor(0.55)
        CO_S2.Sigma=0.01*CO_S2.Meas
        CO_S2.Sol=0.4888261134644
        ...
        F3.Sol=54.4302839983356
        T3=Sensor(27)
        T3.Sigma=0.01*T3.Meas
        T3.Sol=24.7866693840330
        P3=Sensor(95)
        P3.Sigma=0.01*P3.Meas
        P3.Sol=100.3082141145146
        H2_S3=Sensor(0.55)
        H2_S3.Sigma=0.01*H2_S3.Meas
        H2_S3.Sol=0.5111738865356
        CO_S3=Sensor(0.49)
        CO_S3.Sigma=0.01*CO_S3.Meas
        CO_S3.Sol=0.488826113784
...
#==========Matlab Code===================================
'''function [Xopt,Fval,Flag]=SplitterExample()
    FS1=102;
    TS1=25;
    PS1=105;
    COS1=0.49;
...
function [c,ceq]=Cons(X,Xmeas,XFlag)
    ...
    C9=TS1-TS2;
    C10=TS1-TS3;
    ceq=[C1;C2;C3;C4;C5;C6;C7;C8;C9;C10];
    c=[];
end'''