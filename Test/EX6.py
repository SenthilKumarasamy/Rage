...
class Test6():
    def __init__(self,Ctol):
        self.Description='ElementbalanceReactor example where the concentration of the product is measured in terms of CO free basis. Solution obtained from Matlab'   
        self.Type=5
