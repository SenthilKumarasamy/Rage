'''Reactor (Element balance) and Heater'''
import sys
import os
...
class Test19(Test15):
    def __init__(self,Ctol=1e-5,Ptol=1):
        self.Description='Reactor (Element Balance) and Heater'   
        self.Type=7
        ...
        F1.Sol=2.547518414373714e-03
        T1=Sensor(25)
        T1.Sol=2.499996966451582e+01
        P1=Sensor(105)
        P1.Sol=1.023781169733301e+02
        CH4_R=Sensor(0.339)
        ...
        F2.Sol=2.547518414373714e-03
        T2=Sensor(120)
        T2.Sol=1.200008113996864e+02
        P2=Sensor(100)
        P2.Sol=1.023781169733301e+02
        H2O_P=Sensor(0.673)
        H2O_P.Sol=6.666666666666667e-01
        CO2_P=Sensor(0.335)
        CO2_P.Sol=3.333333333333334e-01
        ...
        F11=Sensor(10.1)
        F11.Sol=1.029431165618541e+01
        T11=Sensor(25)
        T11.Sol=2.488765958626912e+01
        P11=Sensor(100)
        P11.Sol=9.897981741038596e+01
        CO_R1=Sensor(0.52)
        CO_R1.Sol=5.038450312645855e-01
        H2_R1=Sensor(0.47)
        H2_R1.Sol=4.961549687354145e-01
        CTag={CO:CO_R1,H2:H2_R1}
        S11=Material_Stream('S11',F11,T11,P11,2,Therm,CTag)
        ListStreams.append(S11)
        
        F21=Sensor(10.5)
        F21.Sol=1.029431165618541e+01
        T21=Sensor(27)
        T21.Sol=2.713107170988016e+01
        P21=Sensor(98)
        P21.Sol=9.897981741038596e+01
        CO_P1=Sensor(0.49)
        CO_P1.Sol=5.038450312645855e-01
        H2_P1=Sensor(0.53)
        H2_P1.Sol=4.961549687354145e-01
        ...
        self.OPT.ObjSol=1.235341433854787e+02
...
#====================Matlab Code========================================
'''
function [Xopt,Fval,Flag]=EBRHeater()
    FR=0.0025;
    TR=25;
    PR=105;
    CH4_R=0.339;
    ...
    Xmeas=[FR;TR;PR;CH4_R;O2_R;FP;TP;PP;CO2_P;H2O_P;FHin;THin;PHin;CO_Hin;H2_Hin;FHout;THout;PHout;CO_Hout;H2_Hout;Q];
    XFlag=ones(21,1);
    XFlag(21)=0;
    LB=zeros(21,1);
    UB=ones(21,1);
    UB([1,2,3,6,7,8,11,12,13,16,17,18,21])=inf;
...
function [C,Ceq] = Cons(X,Xmeas,XFlag)
    ...
    C1=FR*CH4_R-FP*CO2_P; % Carbon Balance
    C2=FR*O2_R*2-FP*CO2_P*2-FP*H2O_P; % Oxygen Balance
    C3=FR*CH4_R*4-FP*H2O_P*2; % Hydrogen Balance
    ...
    C14=PHin-PHout;
    Ceq=[C1;C2;C3;C5;C6;C7;C8;C9;C10;C11;C12;C13;C14];
    C=[];
end
