''' Mixer Test example to check the unit conversion from NM^3/HR to Kmol/Hr and then back to NM^3/HR'''
import sys
import os
...
class Test23():
    def __init__(self,Ctol=1e-5,Ptol=1):
        self.Description='Mixer Test example to check the unit conversion from NM^3/HR to Kmol/Hr and then back to NM^3/HR'
        self.Type=1
