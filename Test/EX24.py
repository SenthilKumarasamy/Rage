''' Mixer Test example to check the unit conversion from SM^3/HR to Kmol/Hr and then back to SM^3/HR'''
import sys
import os
...
class Test24():
    def __init__(self,Ctol=1e-5,Ptol=1):
        self.Description='Mixer Test example to check the unit conversion from SM^3/HR to Kmol/Hr and then back to SM^3/HR'
        self.Type=1
