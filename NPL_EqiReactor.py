...
if __name__=="__main__":
    ...
    str1="D:\\Gyandata\\PythonRage\\RAGE2\\RAGE\\NPLMeas09_06_14.dat"
    R1=Readfile(str1)
    '-----------------------Creating Objects--------------------------------------------'   
...
#     StrmH1=Material_Stream('StrmH1',FIC3103,TI3156,PIC3150,2,T1,CTag2)
    ...
    C2H6_NS3=Sensor('C2H6_NS3',R1.Name,R1.Meas,R1.Sigma,R1.Flag,R1.Unit)
    C3H8_NS3=Sensor('C3H8_NS3',R1.Name,R1.Meas,R1.Sigma,R1.Flag,R1.Unit)
    C4H10_NS3=Sensor('C4H10_NS3',R1.Name,R1.Meas,R1.Sigma,R1.Flag,R1.Unit)
    C5H12_NS3=Sensor('C5H12_NS3',R1.Name,R1.Meas,R1.Sigma,R1.Flag,R1.Unit)
    C6H14_NS3=Sensor('C6H14_NS3',R1.Name,R1.Meas,R1.Sigma,R1.Flag,R1.Unit)
    ...
    StrmNS3.Describe='Pre-Reformer outlet'
    ...
    RE0=Reaction('RE0',[CH4,H2O,CO,H2],[-1.0,-1.0,1.0,3.0])
    RE1=Reaction('RE1',[C2H6,H2O,CO,H2],[-1.0,-2.0,2.0,5.0])
    RE2=Reaction('RE2',[C3H8,H2O,CO,H2],[-1.0,-3.0,3.0,7.0])
    RE3=Reaction('RE3',[C4H10,H2O,CO,H2],[-1.0,-4.0,4.0,9.0])
    RE4=Reaction('RE4',[C5H12,H2O,CO,H2],[-1.0,-5.0,5.0,11.0])
    RE5=Reaction('RE5',[C6H14,H2O,CO,H2],[-1.0,-6.0,6.0,13.0])
    RE6=Reaction('RE6',[CO,H2O,CO2,H2],[-1.0,-1.0,1.0,1.0])
    
    
                           
    '''Definig REX1 (PreReformer1)'''
    #REX1=EquilibriumReactor('REX1',StrmNS2,StrmNS3,[E2],[RE0,RE1,RE2,RE3,RE4,RE5,RE6],ExoEndoFlag=1)
    REX1=EquilibriumReactor('REX1',StrmNS2,StrmNS3,[E2],[RE1,RE2,RE3,RE5],ExoEndoFlag=1)
...
#     StrmNS3a.Describe='Pre-Reformer outlet'
...
#     RE7=Reaction('RE7',[CH4,H2O,CO,H2],[-1,-1,1,3])
#                                 
#     '''Defining REX2 (Steam Reformer) '''
#     REX2=ElementBalanceReactor('REX2',StrmNS5,StrmNS6,[E4],ExoEndoFlag=1)
#     #REX2=EquilibriumReactor2('REX2',StrmNS5,StrmNS6,[E4],[RE7],ExoEndoFlag=1)
#     #REX2=Reactor('REX2',StrmNS5,StrmNS6,[E4],[RE7],ExoEndoFlag=1)
...
#     #REX3=EquilibriumReactor2('REX3',StrmNS7,StrmHT1,[E5],[RE8],ExoEndoFlag=-1)
...
#     #REX4=EquilibriumReactor2('REX4',StrmHT3,StrmLT1,[E6],[RE8],ExoEndoFlag=-1)
